...
if(control == 2){
  for(int i=0; i<400;){
      ...
      if (control == 2){Mov_Mizq (); i = i+1;}
      else if (control == 1){control = 1; i = i+400;}
      else if (control == 4){control = 4; i = i+400;}
      else if (control == 3){control = 3; i = i+400;}
      else if (control == 5){control = 5; i = i+400;}
      ...
      else if (control == 4){control = 4;}
      else if (control == 3){control = 3;}
      else if (control == 5){control = 5;}
      else {control = 6;}}
/*---------------------------------------------------------------------------------*/
    if(control == 3){
...
for (int i=0; i<400;){
      ...
      aPrimePinm2 = 9; //IND 9
      bPrimePinm2 = 11; //INC 11
      if (control == 4){Mov_Mizq (); i=i+1;}
      if (control == 1){control = 1; i = i+400;}
      if (control == 2){control = 2; i = i+400;}
      if (control == 3){control = 3; i = i+400;}
      if (control == 5){control = 5; i = i+400;}
    //digitalWrite(LED_BUILTIN,HIGH);
    //delay(100);
