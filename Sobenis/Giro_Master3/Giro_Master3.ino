...
int sw1 = 0, sw2 = 200, sw3 =0;
float ang_ref = 0, angle_pitch_limit1 = 0, angle_pitch_limit2 = 0; //límites
float SumAngX =0 ,SumAngY =0,SumAngZ =0, SumAng2, RestAng =0;
...
RestAng = SumAng2 - SumAngX;
 ...
 if (ang_ref-1< RestAng < ang_ref+1)
 {
  Wire.beginTransmission(0x50);
  Serial.println("1");
  Wire.write(1);
...
/*void Limites()
{
  ...
  else if (angle_pitch_output < angle_pitch_limit2)
  {  
