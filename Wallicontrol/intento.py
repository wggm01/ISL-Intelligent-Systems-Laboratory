...
#Titulos
ds = ttk.Label(root, text='Distancia_sensores')
imu = ttk.Label(root, text='IMU')
rpm = ttk.Label(root, text='RPM')
cm = ttk.Label(root, text='Control manual')
gps = ttk.Label(root, text='gps_distancia')
#Subtitulos
ds1 = ttk.Label(root, text='Distancia_sensor1')
ds2 = ttk.Label(root, text='Distancia_sensor2')
ds3 = ttk.Label(root, text='Distancia_sensor3')
imu_x = ttk.Label(root, text='IMU_x')
imu_y = ttk.Label(root, text='IMU_y')
rpm_derecho = ttk.Label(root, text='RPM_der')
rpm_izquierdo = ttk.Label(root, text='RPM_izq')

#Espaciones en blanco para los valores
ds1_value = ttk.Label(root,relief="solid",textvariable=ds1_input_str)
ds2_value = ttk.Label(root,relief="solid",textvariable=ds2_input_str)
ds3_value = ttk.Label(root,relief="solid",textvariable=ds3_input_str )
imu_x_value = ttk.Label(root,relief="solid",textvariable=imu_xinput_str)
imu_y_value = ttk.Label(root,relief="solid",textvariable=imu_yinput_str)
rpm_derecho_value = ttk.Label(root,relief="solid",textvariable=rpm_inputder_str)
rpm_izquierdo_value = ttk.Label(root,relief="solid",textvariable=rpm_inputizq_str)
gps_dist_value = ttk.Label(root,relief="solid",textvariable=gps_disinput_str)


#Botones para control manual
F = ttk.Button(root, text='F',command=F)
B = ttk.Button(root, text='B',command=B)
TI = ttk.Button(root, text='TI',command=TI)
TD = ttk.Button(root, text='TD',command =TD)
TIE = ttk.Button(root, text='TIE',command=TIE)
TDE = ttk.Button(root, text='TDE',command=TDE)
TIA = ttk.Button(root, text='TIA',command=TIA)
TDA = ttk.Button(root, text='TDA',command=TDA)
...
ATDI.grid(column=7, row=7)
ATDE.grid(column=8, row=7)
